    ...
    function areTheyRegistered(participants){
      ...
      participants.forEach((each)=>{
        ...
        if(each = currentUserId){
          ...
          console.log('just not returning proper')
        return (  <button type="button" className="btn btn-default col-md-4" onClick={interestedUser.bind(this)}  aria-expanded="false" aria-controls="collapseExample">
                  Interested!
                </button>
                );
      }
