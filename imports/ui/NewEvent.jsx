      ...
      <div>
        ...
        <form className= "new_event form-horizontal" onSubmit={this.handleNewEventSubmit.bind(this)}>
          ...
          <div className="form-group">
            ...
            <div className="col-sm-10">
              <input className="form-control" id="inputLatitude1" type="float" value={this.state.latitude}  onChange={this.updateLatitude} />
            </div>
          </div>
          <div className="form-group">
            <label htmlFor="inputLongtitude1" className="col-sm-2 control-label">Longtitude:</label>
            <div className="col-sm-10">
              <input className="form-control" id="inputLongtitude1" type="float" value={this.state.longitude}  onChange={this.updateLongtitude} />
            </div>
          </div>
          <div className="form-group">
          ...
          <div className="form-group">
            ...
            <div className="col-sm-10">
              <input className="form-control" id="inputMin1" type="number"  value={this.state.max}  onChange={this.updateMin} />
            </div>
          </div>
          <div className="form-group">
            <label htmlFor="inputMax1" className="col-sm-2 control-label">Max Participants:</label>
            <div className="col-sm-10">
              <input className="form-control" id="inputMax1" type="number"  value={this.state.min}  onChange={this.updateMax} />
            </div>
          </div>
          <div className="form-group">
